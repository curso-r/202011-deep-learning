...
knitr::kable(
  tibble::tibble(
    ...
    link = paste0("[link](https://curso-r.github.io/202011-deep-learning/exemplos/", exercicio, ")"),
    gh_link = paste0("[link](https://github.com/curso-r/202011-deep-learning/blob/main/exemplos/", exercicio, ")")
  )
)
```
